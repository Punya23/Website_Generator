...
export const SECTION_TEMPLATES: SectionTemplateDef[] = [
  ...
  },
  {
    id: "hero_statement",
    name: "Statement Hero",
    description: "Typography-only full-viewport opening — no image",
    sectionMode: "bleed",
    defaultMotion: "fade",
    componentName: "HeroStatement",
    propsSchema: TEMPLATE_PROP_SCHEMAS.hero_statement,
  ...
  },
  {
    ...
    description: "Client-side estimate calculator that feeds the contact form",
    sectionMode: "contained",
    defaultMotion: "slide-up",
    componentName: "QuoteCalculator",
    propsSchema: TEMPLATE_PROP_SCHEMAS.quote_calculator,
  ...
  },
  {
    id: "hero_metro",
    name: "Metro Hero",
    description: "Scroll-pinned image reveal — each still comes up over the last, with a coming-up cue",
    sectionMode: "bleed",
    defaultMotion: "parallax",
    componentName: "HeroMetro",
    propsSchema: TEMPLATE_PROP_SCHEMAS.hero_metro,
    pages: ["home", "any"],
  },
  {
  ...
  },
  {
    id: "story_split",
    name: "Story Split",
    description: "Alternating image and long-form story — Start Bootstrap showcase rhythm",
    sectionMode: "contained",
    defaultMotion: "slide-up",
    componentName: "StorySplit",
    propsSchema: TEMPLATE_PROP_SCHEMAS.story_split,
    pages: ["about", "home", "any"],
  },
  {
    id: "offer_index",
    name: "Offer Index",
    description: "Numbered editorial list of services — not a card grid",
    sectionMode: "contained",
    defaultMotion: "stagger",
    componentName: "OfferIndex",
    propsSchema: TEMPLATE_PROP_SCHEMAS.offer_index,
    pages: ["services", "home", "any"],
  },
  {
    id: "hours_location",
    name: "Hours and Location",
    description: "Weekly hours, address, and phone for local businesses",
    sectionMode: "contained",
    defaultMotion: "slide-up",
    componentName: "HoursLocation",
    propsSchema: TEMPLATE_PROP_SCHEMAS.hours_location,
    pages: ["contact", "about", "home"],
  },
  {
    id: "menu_board",
    name: "Menu Board",
    description: "Name, price, and note rows for food, treatments, or packages",
    sectionMode: "contained",
    defaultMotion: "stagger",
    componentName: "MenuBoard",
    propsSchema: TEMPLATE_PROP_SCHEMAS.menu_board,
    pages: ["services", "home", "any"],
  },
];
